...
import com.example.cryptoanalysisai.services.BillingManager;
...
public class SubscriptionActivity extends AppCompatActivity implements BillingManager.BillingStatusListener {
    ...
    private void showSubscriptionManagementDialog() {
        // 실제 앱에서는 Google Play 구독 관리 페이지로 이동하는 코드 추가
        // 여기서는 테스트를 위해 간단한 대화상자로 대체
        new androidx.appcompat.app.AlertDialog.Builder(this)
                .setTitle("구독 관리")
                .setMessage("구독을 취소하려면 Google Play 스토어 > 구독 메뉴에서 관리할 수 있습니다.\n\n" +
                        "구독을 취소해도 현재 결제 기간 동안에는 프리미엄 서비스를 계속 이용할 수 있습니다.")
